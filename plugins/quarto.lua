return {

    {
            ...
            {'hrsh7th/nvim-cmp'}, {
                ...
                config = function()
                    require'otter.config'.setup {
                        lsp = {hover = {border = require'misc.style'.border}}
                    }
                end
            }
        ...
        config = function()
            require'nvim-treesitter.configs'.setup {
                ensure_installed = {
                    'r', 'python', 'markdown', 'markdown_inline', 'julia',
                    'bash', 'yaml', 'lua', 'vim', 'query', 'vimdoc', 'latex',
                    'html', 'css'
                },
                highlight = {
                    enable = true,
    ...
    }, -- completion
    {
        ...
        dependencies = {
            ...
            {'hrsh7th/cmp-buffer'}, {'hrsh7th/cmp-path'}, {'hrsh7th/cmp-calc'},
            {'hrsh7th/cmp-emoji'}, {'saadparwaiz1/cmp_luasnip'},
            {'f3fora/cmp-spell'}, {'ray-x/cmp-treesitter'},
            {'kdheepak/cmp-latex-symbols'}, {'jmbuhr/cmp-pandoc-references'},
            {'L3MON4D3/LuaSnip', version = nil, branch = 'master'},
    ...
    -- like ipython, R, bash
    {
      ...
      return a:text
            ...
            require'which-key'.register({
                ...
                ['<leader>ct'] = {
                    toggle_slime_tmux_nvim, 'toggle tmux/nvim terminal'
                }
            })
        end
